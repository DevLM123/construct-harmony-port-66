...
export const customizationOptions: CustomizationData = {
  ...
  flooring: [
    ...
    { id: 4, name: 'Engineered Wood', description: 'Stable engineered wood with premium top layer', image: 'https://images.unsplash.com/photo-1565374392899-2efd30686c85?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=500&q=80' }
  ],
  paint: [
