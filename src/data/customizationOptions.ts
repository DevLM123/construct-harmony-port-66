...
export const customizationOptions: CustomizationData = {
  ...
  cabinets: [
    ...
    { id: 3, name: 'Glass Front', description: 'Elegant cabinets with glass panel inserts', image: 'https://images.unsplash.com/photo-1584346133934-2543ef372e93?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=500&q=80' },
