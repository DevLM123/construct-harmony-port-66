...
const features: Feature[] = [
  {
    icon: <Building2 className="w-8 h-8 text-amber-800" />,
  ...
  {
    icon: <Landmark className="w-8 h-8 text-amber-800" />,
          ...
          {features.map((feature, index) => (
            <div 
              ...
              className={cn(
                ...
                "animate-fade-up border-amber-200"
              )}
              style={{ animationDelay: `${index * 100}ms` }}
              onClick={() => navigate('/projects')}
            >
              <div className="flex justify-between items-start mb-4">
                <div className="bg-gradient-to-r from-amber-50 to-amber-100 p-3 rounded-xl">
                  {feature.icon}
                </div>
                <div className="p-2 bg-[#1e2832]/10 rounded-full">
                  <ArrowRight className="w-4 h-4 text-[#1e2832] group-hover:text-amber-800 transition-colors" />
                </div>
              </div>
              ...
              <Button variant="outline" className="w-full justify-between group-hover:bg-amber-50 group-hover:text-amber-800 border-amber-200">
