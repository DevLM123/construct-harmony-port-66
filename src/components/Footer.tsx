...
export function Footer() {
  return (
    <footer className="bg-background border-t border-[#e9d9c2]">
      <div className="container mx-auto py-12 px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h4 className="font-medium text-sm uppercase tracking-wider text-[#b09878]">Services</h4>
          ...
          <div className="space-y-4">
            <h4 className="font-medium text-sm uppercase tracking-wider text-[#b09878]">Company</h4>
            <ul className="space-y-3">
          ...
          <div className="space-y-4">
            <h4 className="font-medium text-sm uppercase tracking-wider text-[#b09878]">Legal</h4>
            <ul className="space-y-3">
        ...
        <div className="mt-12 pt-8 border-t border-[#e9d9c2] flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            {['Twitter', 'LinkedIn', 'Facebook', 'Instagram'].map((social) => (
              <Button key={social} variant="ghost" size="sm" className="h-auto p-0 text-sm text-muted-foreground hover:text-[#c6ad8f]">
                {social}
              </Button>
            ))}
          </div>
